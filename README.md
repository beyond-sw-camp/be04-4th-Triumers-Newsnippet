...
## 프로젝트 시나리오
데일리 시사 상식 퀴즈 플랫폼
- 매일 뉴스 사이트에서 최신 기사를 수집하여 GPT로 시사 상식 문제 자동 생성
- 사용자는 웹사이트에 접속하여 매일 새로운 시사 상식 문제를 풀어볼 수 있음
- 문제 풀이 결과와 해설을 제공하여 사용자의 학습 효과 향상
...
AWS EC2를 이용하여 REST API 서버를 배포하였고, 쿠버네티스와 Docker를 활용하여 애플리케이션의 컨테이너화 및 오케스트레이션을 구현하였습니다. GitHub Actions를 통해 CI 파이프라인을, Jenkins를 통해 CD 파이프라인을 구축 및 자동화하였으며, Terraform을 활용하여 인프라 구성과 관리를 자동화하였습니다. 또한, Jira와 GitHub를 통해 효율적인 프로젝트 관리 및 협업을 진행하였습니다. 이러한 기술 스택과 아키텍처를 통해 확장성, 안정성, 유지보수성을 고려한 효율적인 시스템을 구축하였습니다.
<br>
