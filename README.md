...
Newsnippet은 데일리 시사 상식 퀴즈 플랫폼으로 매일 최신 뉴스를 기반으로 자동으로 생성되는 문제들을 풀며 시사 상식을 습득할 수 있는 웹사이트입니다. 사용자들은 퀴즈를 풀고 결과를 확인하며, 해설을 통해 학습 효과를 높일 수 있습니다. 또한, 점수 시스템을 통해 학습 동기를 부여하며, 학습 기록과 통계를 통해 성장을 확인할 수 있습니다.
...
# 3. UI
🔗 [UI](https://github.com/beyond-sw-camp/be04-4th-Triumers-Newsnippet/wiki/3.-UI)
...
# 4. CI/CD(빌드-배포)
🔗 [CI/CD 빌드-배포](https://github.com/beyond-sw-camp/be04-4th-Triumers-Newsnippet/wiki/4.-CI,-CD(빌드%E2%80%90배포))
...
팀원들과 함께 아이디어를 구현해나가는 과정이 즐거웠고, 서로의 의견을 존중하며 협업하는 경험을 통해 많은 것을 배울 수 있었습니다. 하고 싶은 것이 생기면 바로바로 의견을 공유하고 피드백을 서로 했고, 서로 어떤 부분을 맡고 있는지 수시로 공유했기 때문에 크게 막히는 일 없이 진행될 수 있었던 것 같습니다. 
